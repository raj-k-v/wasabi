...
export function IntelligencePanel({
  ...
  return (
    <Card className="relative overflow-hidden bg-teal-900/20 border-teal-900/40 p-8 shadow-sm">
      <div className="relative">
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-teal-400/80">Executive Insight</p>
            ...
            <div className="mt-6 space-y-4">
              ...
              >
                {paragraphs.slice(1).map((paragraph, idx) => (
                  <p key={idx} className="text-muted leading-relaxed max-w-3xl">
                    {paragraph}
                  </p>
                ))}
              </motion.div>
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <span className="text-[10px] font-medium text-muted/60">Generated 2h ago</span>
            </div>
          </div>
        </div>
      </div>
